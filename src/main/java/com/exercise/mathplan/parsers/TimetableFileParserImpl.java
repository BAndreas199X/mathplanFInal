...
public class TimetableFileParserImpl implements TimetableFileParser {
	...
	private Set<String> addCurriculum(String courseID, Map<String, List<String>> curriculumMap) {
